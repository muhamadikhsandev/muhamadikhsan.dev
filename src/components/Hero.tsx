...
// FIX: Menggunakan komponen Image bawaan Next.js untuk optimasi gambar otomatis
...
const Hero = ({ data }: HeroProps) => {
  ...
  const heroContent = data || {
    ...
    description: "Membangun solusi digital yang efisien and modern. Fokus pada performa tinggi dan pengalaman pengguna yang luar biasa.",
    images: [
      ...
      <div className="container mx-auto px-6 max-w-6xl grid md:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="relative flex justify-center items-center order-1 md:order-2">
          <div className="relative w-[260px] h-[320px] md:w-[380px] md:h-[480px]">
            ...
            {/* Wrapper Gambar (Bersih dari fungsi capture) */}
            <div className="relative w-full h-full overflow-hidden rounded-[2.5rem] border border-white/10 shadow-2xl">
              {heroContent.images.map((img, index) => (
                <Image
                  ...
                  fill
                  priority={index === 0} // FIX: Gambar pertama langsung diprioritaskan biar muncul instan!
